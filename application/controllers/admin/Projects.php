...
class Projects extends AdminController
{
     ...
     * Admin-only - mirrors Clients::update_assignment_field(). There is no
     * customer-facing equivalent of this endpoint.
     *
     * @param integer $id
     */
    public function update_assignment_field($id)
    {
        ...
        $this->projects_model->update_assignment_field($id, $field, $this->input->post('value'));
    }
