...
<head>
    ...
    <?php
    $CI = &get_instance();
    $themeVersion = $CI->app_css->core_version();
    if (is_admin()) {
        echo '<link href="' . base_url('assets/css/themes/admin.css') . '?v=' . $themeVersion . '" rel="stylesheet">';
    } else {
        echo '<link href="' . base_url('assets/css/themes/staff.css') . '?v=' . $themeVersion . '" rel="stylesheet">';
    }
    ?>
