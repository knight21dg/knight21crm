            ...
            <div
              ...
              foreach ($staff_departments as $staff_department) {
                  ...
                  ?>
                        ...
                        <div>
                            <?php 
                            $this->db->where('staff_id', $staff_p->staffid);
                            $staff_has_projects = $this->db->count_all_results(db_prefix() . 'project_members') > 0;
                            if ($staff_has_projects) { ?>
                            ...
                            <?php } else { ?>
                                <p class="tw-text-neutral-500 tw-mt-4">No projects assigned.</p>
                            <?php } ?>
                        </div>
                        <?php } ?>
                    </div>
...
<script>
    $(function() {
        init_table_staff_projects(true);
