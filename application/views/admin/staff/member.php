    ...
    <div class="content">
        <div class="tw-max-w-5xl tw-mx-auto">
            ...
            <div class="tw-flex tw-items-center tw-gap-3 tw-mt-4">
                ...
                <a href="<?= admin_url('staff/profile_view/' . $member->staffid); ?>"
                   class="btn btn-info btn-sm tw-inline-flex tw-items-center tw-gap-1"
                   id="btn-view-staff-profile-<?= $member->staffid; ?>"
                   title="View Full Employee Profile">
                    <i class="fa fa-id-card tw-mr-1"></i>
                    View Full Profile
                </a>
            </div>
            <?php } else { ?>
            <h4 class="tw-font-bold tw-text-lg tw-mt-0">
                <?= e($title); ?>
            </h4>
            <?php } ?>
