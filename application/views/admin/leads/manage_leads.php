                        ...
                        if ($isKanBan) { ?>
                            ...
                            <div class="row" id="leads-table">
                              ...
                              $table_data    = [];
                                ...
                                $_table_data[] = [
                                    // Existing Lead custom field (tblcustomfields,
                                    // fieldto='leads') - not a new column, this
                                    // header pairs positionally with the value
                                    // pushed right after status in
                                    // application/views/admin/tables/leads.php.
                                    'name'     => 'Next Follow-up Date',
                                    'th_attrs' => ['class' => 'toggleable', 'id' => 'th-next-follow-up-date'],
                                ];
                                 $_table_data[] = [
...
<script>
    ...
    $(function() {
        ...
        // Click-to-call "Copy Number" action (Call/WhatsApp are plain
        // tel:/https links, no JS needed) - delegated on document since
        // the leads table body is reloaded via AJAX.
        $(document).on('click', '.lead-phone-copy', function(e) {
            ...
            if (navigator.clipboard && phone) {
                navigator.clipboard.writeText(String(phone)).then(function() {
                    alert_float('success', phone + ' copied');
                });
            }
        });
    });
