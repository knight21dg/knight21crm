...
?>
                        ...
                        <?php if (isset($client)) { ?>
                        <div class="form-group">
                            <label class="control-label"><?= _l('client_last_updated'); ?></label>
                            <div>
                                <?= $client->last_updated != '' ? '<span class="text-has-action" data-toggle="tooltip" data-title="' . e(_dt($client->last_updated)) . '">' . e(time_ago($client->last_updated)) . '</span>' : '-'; ?>
                            </div>
                        </div>
                        <?php } ?>
                    </div>
