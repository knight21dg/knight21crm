...
<div class="panel_s">
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <?= render_input('subject', 'subject', '', 'text', ['required' => true]); ?>
            </div>
            <div class="col-md-6">
                <?= render_textarea('description', 'description', '', ['required' => true]); ?>
            </div>
        </div>
        ...
        <?php } else { ?>
        <table class="table dt-table mtop15 table-files" data-order-col="3" data-order-type="desc">
            <thead>
                <tr>
                    <th class="th-files-subject">
                        <?= _l('subject'); ?>
                    </th>
                    <th class="th-files-description">
                        <?= _l('description'); ?>
                    </th>
